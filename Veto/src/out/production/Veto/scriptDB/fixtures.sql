...
((SELECT idVille FROM Ville WHERE Ville.ville_nom_reel = 'Gradignan'), 'Veterinaire', 'Madame', DATE("1999-12-23"), '45 Route de Veto 34530 Mutch', 'vet.test@email.com', '06.34.35.36.37');
...
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Lapin'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC1"), 'PamPam', DATE("2007-10-23")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chien'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC1"), 'Capucine', DATE("2007-10-13")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chien'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC1"), 'Aristide', DATE("2007-10-4")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC1"), 'Barney', DATE("2007-10-5")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Hamster'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC1"), 'Chanel', DATE("2007-10-10")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chien'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC2"), 'Dolph', DATE("2007-2-1")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Lapin'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC2"), 'Fripouille', DATE("2007-2-5")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Noisette', DATE("2007-3-1")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Ducros', DATE("2007-3-2")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Cheval'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Diego', DATE("2007-3-3")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Lapin'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Ed', DATE("2007-3-4")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Earl', DATE("2007-3-5")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Dolf', DATE("2007-3-6")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Boris', DATE("2007-3-7")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Hamster'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC3"), 'Barney', DATE("2007-3-8")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC4"), 'Alex', DATE("2007-4-1")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Chat'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC4"), 'Choupette', DATE("2007-4-5")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Hamster'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC4"), 'PamPam', DATE("2007-4-4")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Hamster'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC4"), 'Houmou', DATE("2007-4-13")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Cheval'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC5"), 'Bounty', DATE("2007-5-5")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Hamster'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC5"), 'Noisette', DATE("2007-5-13")),
((SELECT idEspece FROM Espece WHERE Espece.nom = 'Hamster'), (SELECT idClient FROM Client C INNER JOIN Personne P ON P.idPersonne = C.idClient WHERE P.nom = "TestC5"), 'Gerbille', DATE("2007-5-24"));
...
((SELECT idPersonne FROM Personne P WHERE P.nom = "Veterinaire"), "Signature Veterinaire");

INSERT INTO Ordonnance (idAnimal, idVeterinaire, dateOrdonnance, commentaire) VALUES
((SELECT idAnimal FROM Animal A 
		INNER JOIN Espece E ON E.idEspece = A.idEspece 
		...
		AND A.nom = 'Noisette'), 
(SELECT idVeterinaire FROM Veterinaire V 
		INNER JOIN Personne P ON P.idPersonne = V.idVeterinaire 
